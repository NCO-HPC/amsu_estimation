      subroutine amsua_ret_aqua(nup,at,bt,ispot,ttype,bl,
     &                                 tret,tpw,clq)
c
...
c
      OPEN(56,FILE='amsu_aqualimb_sea.txt')
...
c
      OPEN(66,FILE='amsu_aqualimb_land.txt')
...
c
      OPEN(59,FILE='amsu_aquaregr_sea.txt')
      do i =9,40 ! levels
      read(59,*)
      read(59,*)
...
c          read in  non-sea temperature retrieval coefficients based on raob matchups for 5 to 1000 mb
      OPEN(59,FILE='amsu_aquaregr_land.txt')
      do i =9,40 ! levels
      read(59,*)
      read(59,*)
...
c
      ...
      OPEN(59,FILE='amsu_aquaamsusimreg.txt')
      do i =1,nup ! levels
      read(59,*)
      read(59,*)
      read(59,*) nchz(i), (nchanz(i,k),k=1,nchz(i))
