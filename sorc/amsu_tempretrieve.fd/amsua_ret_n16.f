      ...
      subroutine amsua_ret_n16(nup,at,bt,ispot,ttype,bl,
     &                                 tret,tpw,clq)
c
...
c     04/03/01  Modification for NOAA-16.  Note, I decided not to 
c     apply antenna correction to NOAA-16, since I found that there 
c     is a larger difference between NOAA-16 and NOAA-15 when antenna 
c     corrections are used.  Better not to use antenna corrections.  
c     I plan to regenerate coefficients for NOAA-15 w/o corrections.
c
c     input  integer   nup     regression coefficients, based on 
c                              simulated btemps, are used from
...
c     input  integer   ttype   terrain type  0 = sea, 1 = land, 
...
c
      OPEN(56,FILE='amsu_n16limb_sea.txt')
...
c
      OPEN(66,FILE='amsu_n16limb_land.txt')
...
c
c
c     read in  sea  temperature retrieval coefficients based on 
c     raob matchups for 5 to 1000 mb
c
      OPEN(59,FILE='amsu_n16regr_sea.txt')
      do i =9,40 ! levels
      read(59,*)
      read(59,*)
...
c     raob matchups for 5 to 1000 mb
      OPEN(59,FILE='amsu_n16regr_land.txt')
      do i =9,40 ! levels
      read(59,*)
      read(59,*)
...
c
      ...
      OPEN(59,FILE='amsu_n16amsusimreg.txt')
      do i =1,nup ! levels
      read(59,*)
      read(59,*)
      read(59,*) nchz(i), (nchanz(i,k),k=1,nchz(i))
